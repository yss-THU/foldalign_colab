...
public:
	...
	inline longCellPtr(): similarityScore(big_neg), energyScore(big_neg),
						  state(noState), mblpointer(0) {};
	
	inline longCellPtr(scoreType simSc, scoreType enSc, stateType st, 
					   mbllist* mblptr)
	...
	inline void setPointer(mbllist* mblptr = 0) {mblpointer = mblptr;}
	inline mbllist* getPointer() const {return mblpointer;}
